...
The first option probably wouldn't work since i' hosting this Blog via GitHub Pages, which (probably) might not work, or maybe im wrong about this, and the second option is the same as the first one. So i'm left wit no choice but to use Giscus instead.
